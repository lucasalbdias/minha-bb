...
import { Heart, Cat, Gift, Music, MessageCircleHeart, Sparkles, Camera, Cloud, Moon, Sun } from 'lucide-react';
        ...
        {Array.from({ length: 15 }).map((_, i) => (
          ...
          >
            {i % 3 === 0 ? (
              ...
              <Sparkles size={Math.random() * 15 + 8} fill="#FFD700" />
            ) : (
              <Cat size={Math.random() * 18 + 10} />
            )}
          </div>
        ))}
      </div>
